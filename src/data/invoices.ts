...
export const seedInvoices: Invoice[] = [
  {
    ...
    items: [
      { id: '1', name: 'Brand Guidelines', quantity: 1, price: 1800.90, total: 1800.90 },
    ],
    total: 1800.90,
  },
  {
  ...
  },
  {
    ...
    clientAddress: {
      street: '3 Gotham City',
      city: 'Gotham',
      postCode: 'DC1 9PB',
      country: 'United States',
    },
    items: [
      { id: '1', name: 'Landing Page Design', quantity: 1, price: 6155.91, total: 6155.91 },
    ],
    total: 6155.91,
  },
  {
    ...
    clientEmail: 'anita.wainwright@email.co.uk',
    status: 'draft',
    senderAddress: {
      street: '19 Union Terrace',
      city: 'London',
